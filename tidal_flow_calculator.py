...
class TidalFlowCalculator(Component):
    ...
    def __init__(
        ...
        threshold_shear_stress : float, array, or field name; optional
            Critical shear stress (tau_crit) (Pa)
        ...
        self._threshold_shear_stress = threshold_shear_stress # uses setter below
    ...
    def threshold_shear_stress(self):
        """Critical shear stress (tau_crit)."""
        return self._threshold_shear_stress

    @threshold_shear_stress.setter
    def threshold_shear_stress(self, new_val):
        self._threshold_shear_stress = return_array_at_link(self.grid, new_val)
